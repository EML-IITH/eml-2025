...
const SpeakersSection = () => {
  ...
  const recent_talks_data = [
    ...
    
    {
     ...
     {
     id: 4,
      image: "/images/home/recent-talks/img6.jpg",
      title: "Vijayalakshmi Deshmane",
      description: "Renowned Indian Oncologist, Breast Cancer Specialist, and Women’s Health Advocate"
     },
     {
     id: 5,
      image: "/images/home/recent-talks/img7.jpg",
      title: "Gururaj Deshpande",
      description: "Indian American venture capitalist"
     },
